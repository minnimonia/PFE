...
use UserBundle\Form\CompetenceType;
...
class CompetenceController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('UserBundle\Form\CompetenceType', $competence);
    ...
    {
        $deleteForm = $this->createDeleteForm($competence);
        $editForm = $this->createForm('UserBundle\Form\CompetenceType', $competence);
